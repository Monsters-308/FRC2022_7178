...
public class Intake extends SubsystemBase{
    ...
    private final Compressor m_compressor = new Compressor(CompressorConstants.kModuleID,PneumaticsModuleType.CTREPCM);
    private final Solenoid m_intakeDeploy = new Solenoid(CompressorConstants.kModuleID,PneumaticsModuleType.CTREPCM,0);
