...
public class HangLeft extends SubsystemBase {
    ...
    private final Solenoid m_leftDeploy = new Solenoid(CompressorConstants.kModuleID, PneumaticsModuleType.CTREPCM,
            HangConstants.kLeftDeployPort);
    ...
    public boolean getLowerEncoder() {
        return m_leftHangEncoder.get();// Need something like this but it has to actually work
    }
