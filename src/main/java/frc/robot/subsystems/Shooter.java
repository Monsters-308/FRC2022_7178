...
public class Shooter extends SubsystemBase {
    ...
    public Shooter(Indexer m_index) {
    ...
    public void shooterOn25() {
        m_upperShooterMotor.set(ControlMode.PercentOutput, 0.25);
        m_lowerShooterMotor.set(ControlMode.PercentOutput, 0.25);
    }
