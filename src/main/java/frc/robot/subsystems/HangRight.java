...
public class HangRight extends SubsystemBase {
    ...
    private final Solenoid m_rightDeploy = new Solenoid(CompressorConstants.kModuleID, PneumaticsModuleType.CTREPCM,
            HangConstants.kRightDeployPort);
    ...
    public boolean getLowerEncoder() {
        return m_rightHangEncoder.get();// see left hang for details
    }
